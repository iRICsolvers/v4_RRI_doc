...
By using `UC tools <https://tools.i-ric.info/login/>`_, which is available to anyone upon registration, you can also easily create rainfall data files ("rain.dat"). For the detailed procedure, please refer to "2. Preparation for a rainfall dataset" in the Overview.
